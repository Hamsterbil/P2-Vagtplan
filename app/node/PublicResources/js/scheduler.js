...
var scheduler = (function() {
    return {
        ...
        generate: async function() {
            ...
            const workerCount = vars.workerCount;
            ...
            const schedule = this.assignShifts(users, workerCount, 2220, startDate);
        ...
        assignShifts: function(users, employeesPerShift, maxMinutesPerEmployee, startDate) {
            const schedule = {};
            let minuteCount = {};
            ...
            const shiftTypeIndex = { morning: 0, evening: 1, night: 2 };
            ...
            while(date <= lastDay){
                ...
                // console.log(employeesPerShift[dayName])
                let dayIndex = days.indexOf(dayName);
                const weekdayInfo = `${dayName} - ${date.getDate()}/${date.getMonth() + 1}/${date.getFullYear()}`;
                ...
                for (let shift of shifts){
                    ...
                    let shiftType = shiftToTime[shift];
                    let shiftIndex = shiftTypeIndex[shiftType];
                    ...
                    while (schedule[weekdayInfo][shift].length < employeesPerShift[dayName] && attempts < maxAttempts) {
                        ...
                        let adjustedProbabilities = employees.map((employee, index) => {
                            ...
                            let preferenceBonus = employee.preferences.preferred.includes(dayName) ? 10 : 1;
                            
                            return normalizedProbabilities[index] * penalty + preferenceBonus;
                        });
                ...
                if (date.getDay() === 0 || date.getTime() === lastDay.getTime()){
